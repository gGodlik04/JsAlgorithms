// Реализуй функцию, которая принимает другую функцию и возвращает её "обёрнутую" версию, гарантирующую,
// что оригинальная функция будет вызвана только один раз, при любых повторных вызовах будет возвращаться результат первого вызова.
